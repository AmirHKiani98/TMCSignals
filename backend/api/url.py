...
from .views import find_file_live_view, find_file_view, get_intersections, get_snapshot_view, get_additional_info
...
urlpatterns = [
    ...
    path("get_additional_info/", get_additional_info, name="get-additional-info"),
]